...
###########################
##
##	File: awr_addm_reports_gui.sh
##
##	Author: Jesus Sanchez (jsanchez.consultant@gmail.com)
##
##	Sample run: awr_addm_reports_gui.sh -v [--db <DB NAME>] [-m <EMAIL ADDRESS>] [-t <TNS_ADMIN_PATH>]
##
######################################################################
...
function printUsage {
	msgPrint -title HELP
	msgPrint -blank
	msgPrint -none "Usage: awr_addm_reports_gui.sh [-v] [--test] [--cod <DBNAME> --hula <DBNAME>"
...
# Setting up logs
logFile=${TEMPDIR}/_awr_addm_reports_gui_$$.log
setupLogs start ${logFile}
msgPrint -title "Welcome to the awr_addm_reports_gui Script"
whiptail --backtitle "ADDM & AWR Reports Emailer" \
--title "AWR/ADDM Reports Generator" \
--msgbox "Welcome to the AWR and ADDM automated reports emailer utility" 10 80
# Setting profiling (captures running time)
profiling start "awr_addm_reports_gui_profile_$$"
...
# do
opt=$(whiptail --backtitle "ADDM & AWR Reports Emailer" \
--title "Authentication Method" \
--menu "Select your authenticationn method" 20 90 10 \
...
"Quit" "Exit this script now" 3>&1 1>&2 2>&3)
...
export RUNFILE=${TEMPDIR}/_awr_addm_reports_gui_${database}.tmp
...
profiling stop "awr_addm_reports_gui_profile_$$"
...
then
        ...
        email_msg="ADDM AND AWR Reports Generated by awr_addm_reports_gui.sh script</br>
==========================================================================</br>
</br>
...
then
        ...
        email_msg="AWR Reports Generated by awr_addm_reports_gui.sh script</br>
==========================================================================</br>
</br>
...
then
        ...
        email_msg="ADDM Reports Generated by awr_addm_reports_gui.sh script</br>
==========================================================================</br>
</br>
